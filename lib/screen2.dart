                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str1']+"\n    Learn how to prayer")),
                                      Expanded(
                                        child: Container(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str2']+"\n    Learn all surha")),
                                      Expanded(
                                        child: Container(
                                          child: Icon(Icons.arrow_forward_ios_sharp),
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str3']+"\n    Quibila detection anywere")),
                                      Expanded(
                                        child: Container(
                                          child: Icon(Icons.arrow_forward_ios_sharp),
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str4']+"\n    Find the closest")),
                                      Expanded(
                                        child: Container(
                                          child: Icon(Icons.arrow_forward_ios_sharp),
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str5']+"\n    importent islamic event")),
                                      Expanded(
                                        child: Container(
                                          child: Icon(Icons.arrow_forward_ios_sharp),
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(flex: 3,child: Text(snapshot.data![0]['str6']+"\n     join with other muslim")),
                                      Expanded(
                                        child: Container(
                                          child: Icon(Icons.arrow_forward_ios_sharp),
                                        ),
